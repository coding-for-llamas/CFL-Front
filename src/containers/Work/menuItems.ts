...
const menuItems = [
  ...
  },
  {
    projectType: 'caseStudy',
    type: 'link',
    link: ['/colour-me-phoney', 'https://dl.dropboxusercontent.com/s/j11f2lxgx1pi0lq/Colour%20Me%20Phoney%20Case%20Study.pdf?dl=0'],
    ...
    btnType: ['btn-light', 'btn-dark'],
    ariaLabel: ['Link to the Colour Me Phoney case study', 'Link to the PDF of the Colour Me Phoney case study'],
    iconClass: ['fas fa-eye', 'fas fa-eye'],
  ...
  },
  {
    projectType: 'caseStudy',
    type: 'link',
    link: ['/access-cropping', 'https://dl.dropboxusercontent.com/s/0zmll97ul7p3x71/Access%20Cropping%20Case%20Study.pdf?dl=0'],
    ...
    btnType: ['btn-light', 'btn-dark'],
    ariaLabel: ['Link to the Access Cropping case study', 'Link to the PDF of the Access Cropping case study'],
    iconClass: ['fas fa-eye', 'fas fa-eye'],
